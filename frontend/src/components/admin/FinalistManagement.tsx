...
const FinalistManagement = () => {
    ...
    const fetchFinalists = async () => {
        try {
            const res = await axios.get(`${BASE_URL}/admin/top-finalists`);
    ...
    const handleNotify = async (project: Finalist) => {
        try {
            await axios.post(`${BASE_URL}/admin/notify-finalist/${project.projectId}`);
                                ...
                                <div className="flex justify-center gap-3 mt-4">
                                    <button
                                        onClick={async () => {
                                            ...
                                            try {
                                                await axios.post(`${BASE_URL}/admin/accept-finalist/${selectedProject.projectId}`, {
                                                    rank: selectedRank,

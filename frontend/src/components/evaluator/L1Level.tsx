...
export default function L1Level({ projects, onStatusChange, username, refreshL2List, refreshProjects, refreshLevel1List }) {
    ...
    const fetchSummary = async () => {
        ...
        try {
            ...
            const response = await axios.get(`${BASE_URL}/evaluator/level-1-summary`, {
    ...
    const handleEvaluate = async (project) => {
        ...
        try {
            ...
            await axios.post(`${BASE_URL}/evaluator/evaluate-project`, payload);
    ...
    const handleSkip = async (project) => {
        try {
            ...
            await axios.post(`${BASE_URL}/evaluator/skip-project`, {
                projectId: project.projectId,
